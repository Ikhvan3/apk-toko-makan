...
import 'package:projek_akhir_dicoding/menu_makanan.dart';
import 'package:projek_akhir_dicoding/menu_minuman.dart';
...
class UtamaScreen extends StatelessWidget {
  const UtamaScreen({super.key, required String StartScreen, required String UtamaScreen});
                                ...
                                child: Column(
                                  children: <Widget>[
                                    Container(
                                      ...
                                      child:
                                          Image.asset("images/menu_makan.png"),
                                    ),
                                    SizedBox(height: 7),
                                    Text(
                                      'MENU MAKAN',
